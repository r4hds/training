...
![Fig. 1: Research workflow chart](Intro_to_biostatistics_files/data_work_flow.jpg)
...
![Fig. 2: data analysis workflow chart](Intro_to_biostatistics_files/data_work_flow1.jpg)
...
![Fig. 3: Example of a tabular data](Intro_to_biostatistics_files/data1.jpg) 
...
<div class="columns-2">
  ...
  ![](Intro_to_biostatistics_files/data2.png)

<div class="col2">

<img src="Intro_to_biostatistics_files/data3.png">
...
![](Intro_to_biostatistics_files/data4.png)


<div class="col2">

![](Intro_to_biostatistics_files/data5.png)
...
```{r quiz1}
quiz(
  question("Which of the followings is not a categorical variable?",
    answer("place of delivery"),
    answer("occupation"),
    answer("salary", correct = T, message = "income is monetary. Money can be expressed to as many decimal places as necessary"),
    answer("ethnicity"), 
    allow_retry = TRUE
  )
)
...
```{r quiz2}
quiz(
  question("Which of the followings is a continuous variable?", 
    answer("eye colour"),
    answer("heart rate"),
    answer("CGPA", correct = T),
    allow_retry = TRUE,
...
-   Summarises the number of occurence of each of the levels of the variable.
...
```{r quiz3}
quiz(
  question("What type of chart will you use to visualize PCV (packed cell volume) of respondents collected during a study?", 
    answer("bar chart"),
    answer("pie chart"),
    answer("scatterplot"),
...
```{r quiz4}
quiz(
  question("Which chart is best used to display the trend in HIV prevalence in Nigeria?", 
    answer("bar chart"),
    answer("line plot", correct = TRUE),
    answer("histogram"),
    answer("boxplot"),
    allow_retry = TRUE,
    random_answer_order = TRUE
...
```{r quiz5}
quiz(
  question("Which chart can be used to display the summary statistics of fasting blood sugar in males and females for comparison?", 
...
```{r quiz6}
quiz(
  question("I want to display the relationship between the average income of respondents and their level of education. What type of graph am I going to use?", 
...
```{r quiz7}
quiz(
  question("A researcher is interested in finding out if the age at first marriage in Kwara is statistically different from that in Abuja. What kind of inferential analysis will she do?", 
    answer("chi-square"),
...
```{r quiz8}
quiz(
  question("Following my data collection, I want to know if the number of respondents with diabetes is significantly different from those without diabetes. What type of test statistic will I use?", 
    answer("one-sample t-test"),
    answer("two-sample t-test"),
    answer("chi-square", correct = TRUE),
    answer("ANOVA"),
    allow_retry = TRUE,
    random_answer_order = TRUE
  )
...
```{r quiz9}
quiz(
  question("In my research proposal to compare the serum level DPP4 in diabetes, hypertensives, diabetic-hypertensives and normal people, I told my supervisor that I will be doing a chi-square analysis but he said I was wrong. What test should I have indicated I will perform?", 
    answer("one-sample t-test"),
    answer("two-sample t-test", message = "I have 4 different categories"),
    answer("ANOVA", correct = TRUE),
    answer("correlation", message = "DPP4 is A continuous variable"),
    allow_retry = TRUE,
    random_answer_order = TRUE
  )
)
