...
<img src="intro_to_biostatistics_files/figure-html/data3.png">
...
library(learnr)
quiz(
  question("Which of the following is not a categorical variable?", allow_retry = TRUE,
    answer("place of delivery"),
    answer("occupation"),
    answer("income", correct = TRUE, message = "income is monetary. Money can be expressed to as many decimal places as necessary"),
    answer("ethnicity")
  )
)
```
...
library(learnr)
quiz(
  question("Which of the following is a continuous variable? (select all that applies)", type = "multiple", allow_retry = TRUE,
    answer("colour"),
    answer("CGPA (cummulative grade point average)", correct = TRUE),
